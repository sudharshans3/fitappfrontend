...
const Food = () => {
  ...
  const fetchMeals = async () => {
    try {
      const response = await axios.get('https://fittrackbackend-vme5.onrender.com/api/meals');
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`https://fittrackbackend-vme5.onrender.com/api/meals/${id}`);
      fetchMeals();
    } catch (error) {
