...
const Workouts = () => {
  ...
  const fetchWorkouts = async () => {
    try {
      const response = await axios.get("https://fittrackbackend-vme5.onrender.com/api/workouts");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post("https://fittrackbackend-vme5.onrender.com/api/workouts", workoutData);
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`https://fittrackbackend-vme5.onrender.com/api/workouts/${id}`);
      fetchWorkouts();
    } catch (error) {
